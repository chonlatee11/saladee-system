...
// Reusable quantity stepper — copied VERBATIM from web/src/components/QtyStepper.vue
// (02-05, one brand N apps). Neutral ink + border only — accent is reserved for the
// single primary CTA per screen (UI-SPEC Color). Both hit targets are a full 44×44px
// (WCAG 2.5.5 / NFR-07); the padding, not the glyph, defines the target.
