...
- [ ] **ADM-02**: จัดการสิทธิ์ผู้ใช้ตามบทบาท (เจ้าของ/แอดมิน/ผู้ดูแลแปลง/พนักงานแพ็ก) (FR-34)
- [ ] **ADM-03**: ตั้งค่าระบบ — ช่องทางชำระเงิน, รูปแบบจัดส่ง, โซน/ค่าส่ง, รอบขาย, ราคาประจำวัน (FR-35)

### CROP — วางแผนการปลูก & พยากรณ์ผลผลิต

- [ ] **CROP-01**: ทะเบียนชนิดผัก (Variety) พร้อมพารามิเตอร์ — days-to-harvest, น้ำหนักเฉลี่ย/ต้น, อัตรารอด, หน้าต่างเก็บเกี่ยว (FR-40)
- [ ] **CROP-02**: บันทึกรุ่นปลูก (Planting Batch) — ชนิดผัก, วันปลูก, จำนวนต้น, แปลง/โต๊ะ/ราง (FR-41)
- [ ] **CROP-03**: ระบบคำนวณอัตโนมัติ — วันเก็บคาด, ผลผลิตคาด (ต้น/น้ำหนัก) จากพารามิเตอร์ชนิดผัก (FR-42)
...
- [ ] **CROP-06**: แผนการปลูกผสมต่อรุ่น (Planting Mix) — กำหนดสูตรชนิด/จำนวนต่อรุ่น (~200 ต้น) ระบบสร้างหลาย Batch วันปลูกเดียวกันอัตโนมัติ (FR-50)
