...
- [x] **SALE-03**: ลูกค้าสมัครสมาชิกรายรอบ (Subscription Box) — เลือกแพ็กเกจ/ความถี่, สร้างออเดอร์อัตโนมัติ, ต่ออายุ/หยุดชั่วคราว/ยกเลิก (FR-10)
...
- [x] **DEL-05**: บันทึกเลขพัสดุ/สถานะจัดส่ง (เชื่อม API ขนส่งในเฟสท้าย) (FR-24)
...
- [x] **CUST-03**: ระบบสมาชิก/สะสมแต้ม — สะสมจากยอดซื้อ, แลกส่วนลด/ของแถม, ระดับสมาชิก (FR-27)
...
- [x] **MKT-01**: แอดมินสร้างโปรโมชัน/คูปอง — ส่วนลด %/บาท, ขั้นต่ำ, วันหมดอายุ, จำกัดจำนวนครั้ง, โค้ดเฉพาะกลุ่ม (FR-29)
- [x] **MKT-02**: แชทบอตตอบ/รับออเดอร์บน LINE/Facebook (ดูเมนู, เช็กของ, เปิดออเดอร์, ส่งลิงก์ชำระ) (FR-30)
- [x] **MKT-03**: Broadcast แจ้งโปรโมชันผ่าน LINE OA ตามกลุ่มลูกค้า (FR-31)
- [x] **MKT-04**: รายงาน/วิเคราะห์ยอดขายตามช่วงเวลา/ช่องทาง/สินค้า/รอบ, สินค้าขายดี, ลูกค้าซื้อซ้ำ, AOV (FR-32)

### ADM — หลังบ้าน

- [x] **ADM-01**: แดชบอร์ดสรุปยอดวันนี้/รอบนี้, ออเดอร์ค้างชำระ, ของใกล้หมดรอบ, ผลผลิตรอบหน้า (FR-33)
- [x] **ADM-02**: จัดการสิทธิ์ผู้ใช้ตามบทบาท (เจ้าของ/แอดมิน/ผู้ดูแลแปลง/พนักงานแพ็ก) (FR-34)
- [x] **ADM-03**: ตั้งค่าระบบ — ช่องทางชำระเงิน, รูปแบบจัดส่ง, โซน/ค่าส่ง, รอบขาย, ราคาประจำวัน (FR-35)
...
- [x] **CROP-07**: ระบบแนะนำการปลูกย้อนกลับ — จากดีมานด์เฉลี่ยแนะนำจำนวนต้นที่ควรปลูกแต่ละจันทร์ (FR-45)
...
- [x] **LINE-04**: แชทบอตรับออเดอร์แบบสนทนา + Broadcast โปรโมชันตามกลุ่ม (FR-49)
